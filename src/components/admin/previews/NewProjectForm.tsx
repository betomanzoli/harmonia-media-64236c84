        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input id="client-name" name="client-name" placeholder="Nome completo" />
            </div>
            <div>
              <Label htmlFor="client-email">Email do Cliente</Label>
              <Input id="client-email" name="client-email" type="email" placeholder="email@exemplo.com" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input id="project-title" name="project-title" placeholder="Ex: Música Comercial - Empresa ABC" />
            </div>
            <div>
