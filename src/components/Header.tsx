      ...
      <div className="container mx-auto flex justify-between items-center py-3 px-4">
        ...
        <div className="flex items-center">
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/faq" className={`text-sm ${isActive('/faq') ? 'text-harmonia-green' : 'text-gray-300 hover:text-white'}`}>
              FAQ
            </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-background border border-border rounded-lg shadow-lg mt-2 p-4">
            <nav className="flex flex-col space-y-4">
              ...
              <Link to="/faq" className={`text-sm ${isActive('/faq') ? 'text-harmonia-green' : 'text-gray-300 hover:text-white'}`} onClick={() => setIsMenuOpen(false)}>
                FAQ
              </Link>
